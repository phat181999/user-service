...
export class UserRepository {
  ...
  async createUserWithGoogle(
    userCreate: createUserWithGoogleDto,
  ): Promise<CreateUserGoogle> {
    try {
  ...
  async createUserWithGithub(
    userCreate: createUserWithGithubDto,
  ): Promise<CreateUserGithub> {
    try {
      const { userName, email, image } = userCreate;
      const user = this.userRepo.create({
        userName,
  ...
  async findByUserNameAndEmail(
    ...
    try {
      ...
      this.logger.error(
        `Error finding user by userName and email`,
        error.stack,
      );
      throw error;
    }
  ...
  async updateUserById(
    userId: string,
    userCreate: Partial<CreateUserDTO>,
